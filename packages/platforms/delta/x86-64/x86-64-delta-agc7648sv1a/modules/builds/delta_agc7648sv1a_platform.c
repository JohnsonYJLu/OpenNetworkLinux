...
#define agc7648sv1a_i2c_device_num(NUM){    \
    .name = "delta-agc7648sv1a-i2c-device", \
    .id   = NUM,                           \
    .dev  = {                              \
        .platform_data = &agc7648sv1a_i2c_device_platform_data[NUM], \
...
enum agc7648sv1a_sfp_sysfs_attributes 
{
    SFP_SELECT_PORT,
    SFP_IS_PRESENT,
    SFP_IS_PRESENT_ALL,
...
static struct cpld_platform_data agc7648sv1a_cpld_platform_data[] = {
    [system_cpld] = {
        .reg_addr = CPUPLD_ADDR,
    },
};

static struct cpld_platform_data agc7648sv1a_swpld1_platform_data[] = {
    [swpld1] = {
        .reg_addr = SWPLD1_ADDR,
    },
};

static struct cpld_platform_data agc7648sv1a_swpld2_platform_data[] = {
    [swpld2] = {
        .reg_addr = SWPLD2_ADDR,
    },
};

static struct cpld_platform_data agc7648sv1a_swpld3_platform_data[] = {
    [swpld3] = {
...
/* ---------------- I2C device - start ------------- */
static struct i2c_device_platform_data agc7648sv1a_i2c_device_platform_data[] = {
    {
        // id eeprom
        .parent = 1,
    ...
    },
    {
        // PSU 1 control
        .parent = 31,
        .info = { I2C_BOARD_INFO("dni_agc7648sv1a_psu", 0x58) },
        .client = NULL,
    },
    {
        // PSU 2 control
...
static struct platform_device agc7648sv1a_i2c_device[] = {
    agc7648sv1a_i2c_device_num(0),
    agc7648sv1a_i2c_device_num(1),
    agc7648sv1a_i2c_device_num(2),
    agc7648sv1a_i2c_device_num(3),
    agc7648sv1a_i2c_device_num(4),
    agc7648sv1a_i2c_device_num(5),
    agc7648sv1a_i2c_device_num(6),
    agc7648sv1a_i2c_device_num(7),
    agc7648sv1a_i2c_device_num(8),
    agc7648sv1a_i2c_device_num(9),
    agc7648sv1a_i2c_device_num(10),
    agc7648sv1a_i2c_device_num(11),
    agc7648sv1a_i2c_device_num(12),
    agc7648sv1a_i2c_device_num(13),
    agc7648sv1a_i2c_device_num(14),
    agc7648sv1a_i2c_device_num(15),
    agc7648sv1a_i2c_device_num(16),
    agc7648sv1a_i2c_device_num(17),
    agc7648sv1a_i2c_device_num(18),
    agc7648sv1a_i2c_device_num(19),
    agc7648sv1a_i2c_device_num(20),
    agc7648sv1a_i2c_device_num(21),
    agc7648sv1a_i2c_device_num(22),
    agc7648sv1a_i2c_device_num(23),
    agc7648sv1a_i2c_device_num(24),
    agc7648sv1a_i2c_device_num(25),
    agc7648sv1a_i2c_device_num(26),
    agc7648sv1a_i2c_device_num(27),
    agc7648sv1a_i2c_device_num(28),
    agc7648sv1a_i2c_device_num(29),
    agc7648sv1a_i2c_device_num(30),
    agc7648sv1a_i2c_device_num(31),
    agc7648sv1a_i2c_device_num(32),
    agc7648sv1a_i2c_device_num(33),
    agc7648sv1a_i2c_device_num(34),
    agc7648sv1a_i2c_device_num(35),
    agc7648sv1a_i2c_device_num(36),
    agc7648sv1a_i2c_device_num(37),
    agc7648sv1a_i2c_device_num(38),
    agc7648sv1a_i2c_device_num(39),
    agc7648sv1a_i2c_device_num(40),
    agc7648sv1a_i2c_device_num(41),
    agc7648sv1a_i2c_device_num(42),
    agc7648sv1a_i2c_device_num(43),
    agc7648sv1a_i2c_device_num(44),
    agc7648sv1a_i2c_device_num(45),
    agc7648sv1a_i2c_device_num(46),
    agc7648sv1a_i2c_device_num(47),
    agc7648sv1a_i2c_device_num(48),
    agc7648sv1a_i2c_device_num(49),
    agc7648sv1a_i2c_device_num(50),
    agc7648sv1a_i2c_device_num(51),
    agc7648sv1a_i2c_device_num(52),
    agc7648sv1a_i2c_device_num(53),
    agc7648sv1a_i2c_device_num(54),
    agc7648sv1a_i2c_device_num(55),
    agc7648sv1a_i2c_device_num(56),
    agc7648sv1a_i2c_device_num(57),
    agc7648sv1a_i2c_device_num(58),
    agc7648sv1a_i2c_device_num(59),
    agc7648sv1a_i2c_device_num(60),
    agc7648sv1a_i2c_device_num(61),
    agc7648sv1a_i2c_device_num(62),
    agc7648sv1a_i2c_device_num(63),
    agc7648sv1a_i2c_device_num(64),
    agc7648sv1a_i2c_device_num(65),
    agc7648sv1a_i2c_device_num(66),
    agc7648sv1a_i2c_device_num(67),
};
/* ---------------- I2C device - end ------------- */
...
static ssize_t for_status(struct device *dev, struct device_attribute *dev_attr, char *buf){
    ...
    switch (attr->index) {
        ...
        case SFP_LP_MODE:
            ...
            if (port_t > 48 && port_t < 55) { /* QSFP Port 49-54 */
                VALIDATED_READ(buf, values[0], i2c_smbus_read_byte_data(pdata1[swpld1].client, reg_t), 0);
            } else { /* In agc7648sv1a only QSFP support control LP MODE */
                values[0] = 0;
                mutex_unlock(&dni_lock);
                return sprintf(buf, "%d\n", values[0]);
            }
         ...
         case SFP_RESET:
            ...
            if (port_t > 48 && port_t < 55) { /* QSFP Port 49-54 */
                VALIDATED_READ(buf, values[0], i2c_smbus_read_byte_data(pdata1[swpld1].client, reg_t), 0);
            } else { /* In agc7648sv1a only QSFP support control RESET MODE */
                values[0] = 1;
                mutex_unlock(&dni_lock);
                return sprintf(buf, "%d\n", values[0]);
            }
        ...
        case SFP_RX_LOS:
            ...
            if (port_t > 0 && port_t < 49) { /* SFP */
                VALIDATED_READ(buf, values[0], i2c_smbus_read_byte_data(pdata2[swpld2].client, reg_t), 0);
            } else { /* In agc7648sv1a only SFP support control RX_LOS MODE */
                values[0] = 1;
                mutex_unlock(&dni_lock);
                return sprintf(buf, "%d\n", values[0]);
            }
        ...
        case SFP_TX_DISABLE:
            ...
            if (port_t > 0 && port_t < 49) { /* SFP */
                VALIDATED_READ(buf, values[0], i2c_smbus_read_byte_data(pdata2[swpld2].client, reg_t), 0);
            } else { /* In agc7648sv1a only SFP support control TX_DISABLE MODE */
                values[0] = 1;
                mutex_unlock(&dni_lock);
                return sprintf(buf, "%d\n", values[0]);
            }
        ...
        case SFP_TX_FAULT:
            ...
            if (port_t > 0 && port_t < 49) { /* SFP */
                VALIDATED_READ(buf, values[0], i2c_smbus_read_byte_data(pdata2[swpld2].client, reg_t), 0);
            } else { /* In agc7648sv1a only SFP support control TX_FAULT MODE */
                values[0] = 1;
                mutex_unlock(&dni_lock);
                return sprintf(buf, "%d\n", values[0]);
            }
...
static struct platform_device cpld_device = {
    .name = "delta-agc7648sv1a-cpld",
    .id   = 0,
    .dev = {
        .platform_data  = agc7648sv1a_cpld_platform_data,
        .release        = device_release
    },
};

static struct platform_device swpld1_device = {
    .name = "delta-agc7648sv1a-swpld1",
    .id   = 0,
    .dev  = {
        .platform_data = agc7648sv1a_swpld1_platform_data,
        .release       = device_release
    },
};

static struct platform_device swpld2_device = {
    .name = "delta-agc7648sv1a-swpld2",
    .id   = 0,
    .dev  = {
        .platform_data  = agc7648sv1a_swpld2_platform_data,
        .release        = device_release
    },
};

static struct platform_device swpld3_device = {
    .name               = "delta-agc7648sv1a-swpld3",
    .id                 = 0,
    .dev                = {
                .platform_data   = agc7648sv1a_swpld3_platform_data,
                .release         = device_release
    },
};
...
static struct cpld_mux_platform_data agc7648sv1a_cpld_mux_platform_data[] = {
    {
        .parent         = BUS0,
...
static struct cpld_mux_platform_data agc7648sv1a_swpld1_mux_platform_data[] = {
    {
        .parent         = BUS5,
...
static struct cpld_mux_platform_data agc7648sv1a_swpld3_mux_platform_data[] = {
    {
        .parent         = BUS2,
...
{
    {
        .name           = "delta-agc7648sv1a-cpld-mux",
        .id             = 0,
        .dev            = {
                .platform_data   = &agc7648sv1a_cpld_mux_platform_data[0],
                .release         = device_release,
        },
    },
};
...
{
    {
        .name = "delta-agc7648sv1a-swpld1-mux",
        .id   = 0,
        .dev  = {
            .platform_data = &agc7648sv1a_swpld1_mux_platform_data[0],
            .release       = device_release,
        },
    },
    {
        ...
        .id   = 1,
        .dev  = {
            .platform_data = &agc7648sv1a_swpld1_mux_platform_data[1],
            .release       = device_release,
        },
    },
};
...
{
    {
        .name = "delta-agc7648sv1a-swpld3-mux",
        .id   = 0,
        .dev  = {
            .platform_data  = &agc7648sv1a_swpld3_mux_platform_data[0],
            .release        = device_release,
        },
    },
    {
        ...
        .id   = 1,
        .dev  = {
            .platform_data  = &agc7648sv1a_swpld3_mux_platform_data[1],
            .release        = device_release,
        },
    },
};
...
static int __init delta_agc7648sv1a_platform_init(void)
{
//    struct i2c_client *client;
    ...
    mutex_init(&dni_lock);
    printk("agc7648sv1a_platform module initialization\n");
    ...
    cpld_pdata = agc7648sv1a_cpld_platform_data;
    ...
    swpld1_pdata = agc7648sv1a_swpld1_platform_data;
    for (i = 0; i < ARRAY_SIZE(swpld1_mux_device); i++)
    {
        ...
        if (ret) {
            ...
            goto error_agc7648sv1a_swpld1_mux;
        }
    }

    // link the SWPLD3 and the Mux
    swpld3_pdata = agc7648sv1a_swpld3_platform_data;
    for (i = 0; i < ARRAY_SIZE(swpld3_mux_device); i++)
    {
        ...
        if (ret) {
            ...
            goto error_agc7648sv1a_swpld3_mux;
        }
    }

    for (i = 0; i < ARRAY_SIZE(agc7648sv1a_i2c_device); i++)
    {
        ret = platform_device_register(&agc7648sv1a_i2c_device[i]);
        if (ret) 
        {
            printk(KERN_WARNING "Fail to create i2c device %d\n", i);
            goto error_agc7648sv1a_i2c_device;
        }
    }
    if (ret)
        goto error_cpld_mux;
...
error_agc7648sv1a_i2c_device:
    i--;
    for (; i >= 0; i--) {
        platform_device_unregister(&agc7648sv1a_i2c_device[i]);
    }
    i = ARRAY_SIZE(swpld3_mux_device);
error_agc7648sv1a_swpld3_mux:
    i--;
    for (; i >= 0; i--) {
        platform_device_unregister(&swpld3_mux_device[i]);
    }
    i = ARRAY_SIZE(swpld1_mux_device);
error_agc7648sv1a_swpld1_mux:
    i--;
    for (; i >= 0; i--) {
...
static void __exit delta_agc7648sv1a_platform_exit(void)
{
    int i = 0;
...
module_init(delta_agc7648sv1a_platform_init);
module_exit(delta_agc7648sv1a_platform_exit);

MODULE_DESCRIPTION("DELTA agc7648sv1a Platform Support");
