...
class OnlPlatform_x86_64_delta_agc7648sv1a_r0(OnlPlatformDelta,
                                              OnlPlatformPortConfig_32x100):
    PLATFORM='x86-64-delta-agc7648sv1a-r0'
    MODEL="AGC7648SV1A"
    ...
    def baseconfig(self):
        ...
        self.insmod('delta_agc7648sv1a_platform')

        #Insert psu module
        self.insmod('dni_agc7648sv1a_psu')
